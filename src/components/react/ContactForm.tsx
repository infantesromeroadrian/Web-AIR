      ...
      {status === "success" ? (
        ...
        >
          ...
          <button
            ...
            className="min-h-11 mt-6 font-mono text-xs text-[var(--color-text-muted)] transition-colors hover:text-[var(--color-accent)]"
          >
            {labels.again}
          </button>
        </div>
        ...
        >
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                autoComplete="name"
                maxLength={100}
                className="w-full rounded-lg border border-[var(--color-border)] bg-[var(--color-bg-primary)]/80 px-4 py-2.5 text-sm text-[var(--color-text-primary)] placeholder-[var(--color-text-muted)] outline-none transition-colors focus:border-[var(--color-accent)] disabled:cursor-not-allowed disabled:opacity-50"
          ...
          <div>
            <label htmlFor="company" className="mb-1.5 block text-xs font-mono uppercase tracking-wider text-[var(--color-text-muted)]">
              {labels.company} <span className="normal-case text-[var(--color-text-muted)]">{labels.companyOptional}</span>
            </label>
            <input
              id="company"
              type="text"
          ...
          <div>
            ...
            <textarea
              ...
              rows={5}
              maxLength={2000}
              className="w-full resize-y rounded-lg border border-[var(--color-border)] bg-[var(--color-bg-primary)]/80 px-4 py-2.5 text-sm text-[var(--color-text-primary)] placeholder-[var(--color-text-muted)] outline-none transition-colors focus:border-[var(--color-accent)] disabled:cursor-not-allowed disabled:opacity-50"
              placeholder={labels.messagePlaceholder}
            />
            <div className="mt-1 text-right font-mono text-xs text-[var(--color-text-muted)]">
          ...
          <button
            type="submit"
            disabled={disabled}
            className="w-full rounded-lg bg-[var(--color-accent)] px-6 py-3.5 font-mono text-sm font-semibold text-[var(--color-bg-primary)] transition-colors hover:bg-[var(--color-accent-glow)] hover:shadow-lg hover:shadow-[var(--color-accent)]/20 disabled:cursor-not-allowed disabled:opacity-50"
          >
