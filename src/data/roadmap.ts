...
export const EVOLUTIONS: EvolutionStage[] = [
  { tag: "AI", name: "Adrian Infantes", title: "Estudiante", min: 0, max: 15, color: "#3b82f6", glow: "rgba(59,130,246,.4)", img: "/roadmap/l4-deeplearning.png", desc: { en: "Fundamentals. The base everyone needs.", es: "Fundamentos. La base que todos necesitan." } },
  { tag: "AI", name: "Adrian Infantes", title: "Ingeniero", min: 15, max: 30, color: "#06b6d4", glow: "rgba(6,182,212,.4)", img: "/roadmap/l4-teaching.png", desc: { en: "Senior IC level. 90k - 120k EUR Spanish market.", es: "Senior IC. 90k - 120k EUR mercado espanol." } },
  { tag: "L4", name: "L4tentNoise", title: "Shadow Operative", min: 30, max: 50, color: "#a855f7", glow: "rgba(168,85,247,.4)", img: "/roadmap/l4-redteam-analysis.png", desc: { en: "Red Team specialist. 150k - 220k EUR remote / EU.", es: "Especialista Red Team. 150k - 220k EUR remoto / UE." } },
  { tag: "L4", name: "L4tentNoise", title: "The Architect", min: 50, max: 72, color: "#ef4444", glow: "rgba(239,68,68,.5)", img: "/roadmap/l4-aws-redteam.png", desc: { en: "Tier 2 frontier (Mistral / Cohere / HF). 200k - 350k USD.", es: "Tier 2 frontera (Mistral / Cohere / HF). 200k - 350k USD." } },
  { tag: "T1", name: "L4tentNoise", title: "Tier 1 Operator", min: 72, max: 92, color: "#fbbf24", glow: "rgba(251,191,36,.55)", img: "/roadmap/l4-aws-redteam.png", desc: { en: "Applied / Engineering at Anthropic / OpenAI / NVIDIA. 300k - 500k USD.", es: "Applied / Engineering en Anthropic / OpenAI / NVIDIA. 300k - 500k USD." } },
  { tag: "FV", name: "L4tentNoise", title: "Field Voice", min: 92, max: 101, color: "#fde047", glow: "rgba(253,224,71,.65)", img: "/roadmap/l4-aws-redteam.png", desc: { en: "Cited by frontier labs. Defining the field. 500k+ USD + equity.", es: "Citado por frontier labs. Definiendo el campo. 500k+ USD + equity." } },
];
    ...
    phases: [
      {
        ...
        name: "Matematicas",
        topics: [
          { name: "Algebra Lineal Mastery", st: "prog", h: 60, detail: "Khan LA full + 3B1B + 2 certs publicos.", res: "Khan Academy + 3Blue1Brown + Coursera DeepLearning.AI", tags: [{ t: "cert", l: "2x" }], items: ["3B1B Essence of LA Cap 1: Vectors", "3B1B Essence of LA Cap 2: Linear combinations / span / basis", "3B1B Essence of LA Cap 3: Linear transformations and matrices", "3B1B Essence of LA Cap 4: Matrix multiplication as composition", "3B1B Essence of LA Cap 5: Three-dimensional transformations", "3B1B Essence of LA Cap 6: The determinant", "3B1B Essence of LA Cap 7: Inverse matrices, column space, null space", "3B1B Essence of LA Cap 8: Nonsquare matrices as transformations between dimensions", "Khan LA Unit 1: Vectors and spaces (mastery)", "Khan LA Unit 2: Matrix transformations (mastery)", "Khan LA Unit 3: Alternate coordinate systems / bases (mastery)", "Cert Coursera Linear Algebra for ML (DeepLearning.AI / Luis Serrano)", "Cert Khan Academy Linear Algebra (course mastery)"] },
          { name: "Algebra Lineal Capstone", st: "pend", h: 25, detail: "Implementaciones numpy + derivaciones a mano.", res: "Notebooks numpy + papel", items: ["Implementar operaciones matriciales en numpy (matmul, transpose, det, inv)", "Investigar autovalores: 3B1B Cap final + implementar np.linalg.eig", "Implementar PCA desde cero numpy sobre MNIST", "Derivar normal equation a mano (least squares)", "Leer MML Book Cap 4 sobre SVD + implementar SVD truncado"] },
          { name: "Calculo Mastery", st: "prog", h: 80, detail: "Khan Multivariable + 3B1B Calc + 3B1B NN + cert publico.", res: "Khan Academy + 3Blue1Brown + MIT OCW", tags: [{ t: "cert", l: "1x" }], items: ["3B1B Essence of Calculus Cap 1-10 (limites, derivada, integral, chain rule visual)", "3B1B Neural Networks Cap 1: But what is a neural network", "3B1B Neural Networks Cap 2: Gradient descent how neural networks learn", "3B1B Neural Networks Cap 3: What is backpropagation really doing", "3B1B Neural Networks Cap 4: Backpropagation calculus", "Khan Multivariable Unit 1: Thinking about multivariable functions (mastery)", "Khan Multivariable Unit 2: Derivatives of multivariable functions (mastery)", "Khan Multivariable Unit 3: Applications of multivariable derivatives (mastery)", "Khan Multivariable Unit 4: Integrating multivariable functions (mastery)", "Khan Multivariable Unit 5: Greens / Stokes / divergence theorems (mastery)", "Cert Khan Academy Multivariable Calculus (course mastery)"] },
          { name: "Calculo Capstone", st: "prog", h: 25, detail: "Implementaciones numpy + chain rule a mano.", res: "Notebooks numpy + papel", items: ["Implementar gradient descent en numpy (regresion lineal toy)", "Derivar chain rule de backprop a mano (red 2 capas + verificacion numerica)", "Implementar backprop red 2 capas en numpy (forward + backward + update)", "Implementar Adam + graficar loss curves vs SGD", "Implementar cosine annealing schedule en numpy", "Explicar chain rule + gradient descent a ARCA (Q&A oral EN)"] },
          { name: "Probabilidad Mastery", st: "prog", h: 100, detail: "Khan Stats and Probability full + cert publico.", res: "Khan Academy + MML Book Cap 8", tags: [{ t: "cert", l: "1x" }], items: ["Khan Stats Unit 1: Analyzing categorical data (mastery)", "Khan Stats Unit 2: Displaying and comparing quantitative data (mastery)", "Khan Stats Unit 3: Summarizing quantitative data (mastery)", "Khan Stats Unit 4: Modeling data distributions (mastery)", "Khan Stats Unit 5: Exploring bivariate numerical data (mastery)", "Khan Stats Unit 6: Study design (mastery)", "Khan Stats Unit 7: Probability + Bayes (mastery)", "Khan Stats Unit 8: Counting permutations combinations (mastery)", "Khan Stats Unit 9: Random variables (mastery)", "Khan Stats Unit 10: Sampling distributions + CLT (mastery)", "Khan Stats Unit 11: Confidence intervals (mastery)", "Khan Stats Unit 12: Significance tests / hypothesis testing / z-tests (mastery)", "Khan Stats Unit 13: Two-sample inference (mastery)", "Khan Stats Unit 14: Inference for categorical data / chi-square (mastery)", "Khan Stats Unit 15: Advanced regression (mastery)", "Khan Stats Unit 16: ANOVA (mastery)", "Cert Khan Academy Statistics and Probability (course mastery)"] },
          { name: "Probabilidad Capstone", st: "pend", h: 30, detail: "Implementaciones numpy + simuladores propios.", res: "Notebooks numpy + scipy", items: ["Implementar Naive Bayes from scratch sobre 20newsgroups (>=95% accuracy)", "Implementar z-test two-sample from scratch + verificar contra scipy", "Implementar t-test from scratch + comparativa con z-test", "Construir A/B testing simulator (power analysis + significancia)", "Estudiar MLE y MAP MML Book Cap 8 + derivar a mano"] },
          { name: "Information Theory", st: "pend", h: 20, detail: "Entropy, KL, MI. Base de RLHF y mech interp.", res: "MacKay ITILA + Cover & Thomas", tags: [{ t: "v5", l: "T1" }], items: ["Definir entropy, cross-entropy, KL divergence (a mano)", "Implementar KL divergence numpy + verificar asimetria", "Implementar mutual information entre 2 variables discretas", "Derivar cross-entropy loss desde MLE (a mano)", "Leer MacKay ITILA Caps 1-4", "Conectar KL con RLHF reward model + DPO loss (1 parrafo EN)", "Explicar por que KL es la metrica de Constitutional AI (Q&A ARCA)"] },
          { name: "Tiny GPT from scratch", st: "pend", h: 40, detail: "Karpathy nanoGPT + derivar toda la math a mano. Capstone F0.", res: "Karpathy makemore + Let's build GPT + nanoGPT", tags: [{ t: "v5", l: "CAP" }], items: ["Reproducir Karpathy makemore parts 1-7 en notebook propio", "Reproducir Karpathy Let's build GPT (YouTube + repo)", "Derivar attention math en papel: Q K V softmax scaled dot-product", "Derivar backprop a traves de attention paso a paso (con verificacion numerica)", "Implementar nanoGPT desde cero NO copy-paste en RTX 2000 Ada", "Entrenar sobre tiny shakespeare + lograr loss <2.0", "Generar texto coherente + medir perplexity", "Escribir blog post EN explicando cada operacion matematica", "Defender el proyecto en mock interview EN 30min"], boss: true },
        ],
      },
      {
        id: "1",
    ...
    phases: [
      ...
      },
      {
        ...
        topics: [
          ...
          { name: "Cost + Reliability Eng", st: "pend", h: 50, detail: "$/1M tokens + SLOs + multi-region + on-call.", res: "Site Reliability Engineering (Google book) + Eugene Yan + AWS Well-Architected", tags: [{ t: "v5", l: "T1" }], items: ["Definir SLOs concretos: availability 99.9% + p99 latency", "Error budget tracking + burn rate alerts", "Cost per 1M tokens: medir + optimizar 30% via batching/caching", "Multi-region active-active vs active-passive: trade-offs", "Failover automatico: RTO < 60s + RPO < 5min", "Chaos engineering: 3 game days simulando fallos reales", "Runbook completo + incident postmortems publicos", "Capacity planning: forecast trafico + provisioning"] },
    ...
    phases: [
      {
        ...
        name: "Portfolio",
        topics: [
          { name: "OSS", st: "pend", h: 40, detail: "PRs en repos AI/security tier-1.", res: "github.com/langchain-ai + Anthropic + EleutherAI + garak + PyRIT", tags: [{ t: "v5", l: "AI sec" }], items: ["3+ PRs docs/typos/tests en langgraph o langchain", "2+ PRs bug fixes en garak o PyRIT", "1+ PR feature en repo tier-1 (anthropic-cookbook, transformers, vllm)", "1+ PR docs en transformer-lens o sae-lens", "GitHub activity: streak >=180 dias verde", "OSS profile: README publico + lista de PRs merged"] },
          { name: "P1: RT Tool", st: "pend", h: 120, detail: "Scanner citable. Target: usado por >=1 frontier lab.", res: "garak architecture + PyRIT orchestrator + own design", tags: [{ t: "v5", l: "MAIN" }], items: ["CLI con plugins modulares (Click + entry_points)", "5+ tecnicas de prompt manipulation implementadas", "Scanner para MCP servers: enumerate tools + test boundaries", "Probar 5+ MCP servers del registry oficial", "Pipeline de adversarial prompt discovery automatizado", "Eval framework: report con metricas before/after defense", "80% coverage pytest + mypy strict", "CI/CD con GitHub Actions + release semver", "Documentacion site (mkdocs) + 1 blog post architecture", "Target hard: >=200 GitHub stars en 12 meses", "Target hard: >=3 contributors externos con PRs merged", "Target hard: usado en >=1 evaluacion publica de frontier lab"] },
          { name: "P2: Agent", st: "pend", h: 60, detail: "Multi-agent seguro probado con P1.", items: ["Arquitectura supervisor + 3 specialists (LangGraph)", "Integrar 2+ MCP servers (1 propio + 1 registry)", "RAG seguro: input validation + output filtering", "Guardrails AI / Llama Guard como capa de defensa", "Audit trail: input -> trace -> tool calls -> output", "Probar P2 con P1 RT Tool y publicar mitigaciones", "Deploy en Docker self-hosted + Postgres checkpoint", "Repo publico + README con threat model documentado"] },
          { name: "P3: E2E", st: "pend", h: 100, detail: "App produccion integrando P1 + P2 + monitoring.", items: ["App produccion AWS (Bedrock + Lambda + API Gateway)", "Frontend Next.js consumiendo agent (P2)", "Auth: OAuth + JWT + role-based access control", "Security: P1 RT Tool ejecutado en CI antes de cada release", "Observability: LangSmith + Prometheus + Grafana", "Cost dashboard + budget alerts (CloudWatch)", "Load test con k6: p50/p95/p99 + capacity planning", "Blog post EN explicando arquitectura completa", "Red team report propio publicado", "Defensa publica del proyecto en 1 charla / podcast"], boss: true },
        ],
      },
      {
        id: "9",
        name: "Visibilidad",
        topics: [
          { name: "Presencia", st: "pend", h: 30, detail: "Posts cortos virales. Distinto de F5 essays.", items: ["6 LinkedIn posts EN sobre hallazgos cortos AI sec", "X / Twitter: 1 thread tecnico por semana sostenido 12 meses", "1 charla meetup local (DEF CON Madrid / OWASP Spain)", "1 charla en conferencia tecnica (BSides / RootedCON)", "LinkedIn optimizado: SEO + featured + skills validated", "GitHub README profile con metrics + projects pinned"] },
          { name: "Internal Referrals", st: "pend", h: 60, detail: "Variable de mayor impacto Tier 1 que no aparece en CVs.", res: "X / GitHub issue threads / NeurIPS+ICLR socials", tags: [{ t: "v5", l: "T1" }], items: ["Identificar 10 engineers tier-1 (Anthropic / OpenAI / NVIDIA / xAI / DeepMind) por nombre y track", "Sostener 6+ meses de interaccion tecnica genuina con 5 de ellos en X", "PRs merged en repos donde ellos contribuyen + comment en issue review", "1 reply tecnico que reciba quote-tweet o estrella publica de uno de ellos", "Asistir presencialmente a 1 evento donde estan (DEF CON AI Village / NeurIPS workshop / Anthropic meetup)", "Conversacion 1-1 (cafe / video) con 3 de ellos antes de aplicar", "Target hard: >=3 engineers tier-1 que conozcan tu nombre cuando vean tu application"] },
          { name: "High-Signal OSS", st: "pend", h: 60, detail: "PRs merged en los repos que ELLOS mantienen.", res: "transformers + vllm + triton + inspect-ai + sae-lens + pytorch + langgraph", tags: [{ t: "v5", l: "OSS" }], items: ["Identificar 5 repos tier-1 con maintainers de Anthropic / OpenAI / NVIDIA", "Leer 20+ issues etiquetados good-first-issue / help-wanted en cada uno", "1 PR de bug fix non-trivial en transformers o pytorch", "1 PR de bug fix en vllm o triton", "1 PR de feature en inspect-ai o sae-lens", "1 PR docs no-trivial (con ejemplo ejecutable) en langgraph", "Target hard: >=5 PRs merged total con review de un maintainer tier-1", "Cross-link cada PR en LinkedIn con tag al maintainer"] },
          { name: "OSS Maintainership", st: "pend", h: 50, detail: "P1 RT Tool con traccion real.", res: "github.com/<adrian>/<P1>", tags: [{ t: "v5", l: "MAINT" }], items: ["P1 RT Tool: >=200 stars en 12 meses", "Aceptar 5+ external PRs con review riguroso", "3+ contributors externos con PRs merged", "Roadmap publico + milestones + good-first-issue labels", "Release semver cada 4-6 semanas con changelog publico", "Documentation site (mkdocs / docusaurus) live", "1 mencion organica en HackerNews / Reddit r/MachineLearning", "1 cita en paper academico o industry blog tier-1"] },
          { name: "Entrevistas", st: "pend", h: 50, detail: "System design + mocks + behavioral. (LC vive en F1)", items: ["10 ML system designs whiteboarded en EN 45min", "5+ mock interviews coding EN con feedback grabado", "5+ mock interviews ML system design EN", "3+ mock interviews behavioral STAR format EN", "Transformer en pizarra 45min sin notas", "Adversarial attack en pizarra 30min sin notas", "AI Sec deep dive 60min listo para senior panel"] },
          { name: "Field Recognition", st: "pend", h: 60, detail: "El campo cita tu trabajo. Aspiracional <5%.", res: "arXiv + own blog + LessWrong + AlignmentForum + DEF CON CFP", tags: [{ t: "v5", l: "FV" }], items: ["Identificar gap original (no replica de paper existente)", "Implementacion + ablations rigurosas con dataset publico", "Writeup tecnico EN >=3000 palabras + repo reproducible", "Publicar en blog propio + cross-post LessWrong + Alignment Forum", "Tweet thread + LinkedIn post el dia del release", "Target hard: >=1 cita en paper academico", "Target hard: >=1 industry mention (Anthropic blog / OpenAI cookbook / NVIDIA dev blog)", "Target hard: charla aceptada en DEF CON main track / BSides / NeurIPS workshop", "Sinergia con F5 ArXiv: si el finding encaja, convertir en submission cs.CR / cs.LG"], boss: true },
        ],
      },
    ],
  },
