...
export const EVOLUTIONS: EvolutionStage[] = [
  { tag: "AI", name: "Adrian Infantes", title: "Fundamentals", min: 0, max: 15, color: "#3b82f6", glow: "rgba(59,130,246,.4)", img: "/roadmap/roadmap-deeplearning.png", desc: { en: "Fundamentals. The base every AI Security engineer needs.", es: "Fundamentos. La base que necesita cualquier AI Security Engineer." } },
  { tag: "AI", name: "Adrian Infantes", title: "AI Engineer", min: 15, max: 30, color: "#06b6d4", glow: "rgba(6,182,212,.4)", img: "/roadmap/roadmap-teaching.png", desc: { en: "Senior IC level. Production AI engineering with measurable impact.", es: "Senior IC. Ingeniería de IA en producción con impacto medible." } },
  { tag: "SEC", name: "Adrian Infantes", title: "AI Security", min: 30, max: 50, color: "#a855f7", glow: "rgba(168,85,247,.4)", img: "/roadmap/roadmap-redteam-analysis.png", desc: { en: "AI Security specialist focused on red teaming, evals, and model risk.", es: "Especialista en AI Security: red teaming, evals y riesgo de modelo." } },
  { tag: "ARCH", name: "Adrian Infantes", title: "Architect", min: 50, max: 72, color: "#ef4444", glow: "rgba(239,68,68,.5)", img: "/roadmap/roadmap-aws-redteam.png", desc: { en: "Architecture track for regulated, observable, and reversible AI systems.", es: "Arquitectura para sistemas de IA regulados, observables y reversibles." } },
  { tag: "T1", name: "Adrian Infantes", title: "Frontier", min: 72, max: 92, color: "#fbbf24", glow: "rgba(251,191,36,.55)", img: "/roadmap/roadmap-aws-redteam.png", desc: { en: "Applied AI Security track for Anthropic, OpenAI, NVIDIA, and similar teams.", es: "Track Applied AI Security para Anthropic, OpenAI, NVIDIA y equipos similares." } },
  { tag: "REC", name: "Adrian Infantes", title: "Field Voice", min: 92, max: 101, color: "#fde047", glow: "rgba(253,224,71,.65)", img: "/roadmap/roadmap-aws-redteam.png", desc: { en: "Field recognition: published work, citations, and practical influence.", es: "Reconocimiento de campo: trabajo publicado, citas e influencia práctica." } },
];
    ...
    phases: [
      {
        ...
        name: "Matematicas",
        topics: [
          { name: "Algebra Lineal Mastery", st: "prog", h: 50, detail: "3B1B intuicion (caps 1-3 done) + Khan LA Unit 1 + Imperial College London spec.", res: "3Blue1Brown + Khan Academy + Coursera Imperial College London", tags: [{ t: "cert", l: "2x" }], items: ["3B1B Essence of LA Cap 1: Vectors", "3B1B Essence of LA Cap 2: Linear combinations / span / basis", "3B1B Essence of LA Cap 3: Linear transformations and matrices", "Khan LA Unit 1: Vectors and spaces (mastery)", "Imperial College London — Mathematics for Machine Learning · Course 1: Linear Algebra", "Cert Coursera Linear Algebra for ML (DeepLearning.AI / Luis Serrano)", "Cert Coursera Mathematics for Machine Learning Specialization (Imperial College London — bundled 3 cursos)"] },
          ...
          { name: "Calculo Mastery", st: "pend", h: 50, detail: "Imperial College London Multivariate Calculus + PCA. Sustituye Khan Multivariable + 3B1B Calc/NN forward.", res: "Coursera Imperial College London — Mathematics for ML Specialization", tags: [{ t: "cert", l: "spec" }], items: ["Imperial College London — Mathematics for Machine Learning · Course 2: Multivariate Calculus", "Imperial College London — Mathematics for Machine Learning · Course 3: PCA (Principal Component Analysis)"] },
